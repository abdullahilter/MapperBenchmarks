...
public static class Extensions
{
    public static SpotifyAlbum Map(this SpotifyAlbumDto spotifyAlbumDto)
    {
        return new SpotifyAlbum
        {
            ...
            Artists = spotifyAlbumDto.Artists?
                .Select(spotifyAlbumDtoArtist => new Artist
                {
            ...
            Copyrights = spotifyAlbumDto.Copyrights?
                .Select(spotifyAlbumDtoCopyright => new Copyright
                {
            ...
            Images = spotifyAlbumDto.Images?
                .Select(spotifyAlbumDtoImage => new Image
                {
            ...
            Tracks = new Tracks
            {
                ...
                Items = spotifyAlbumDto.Tracks?.Items?
                    .Select(spotifyAlbumDtoTracksItem => new Item
                    {
                        Artists = spotifyAlbumDtoTracksItem.Artists?
                            .Select(spotifyAlbumDtoTracksItemArtist => new Artist
                            {
                                ExternalUrls = new ExternalUrls
                                {
                    ...
                    .ToArray(),
                Limit = spotifyAlbumDto.Tracks?.Limit ?? 0,
                Next = spotifyAlbumDto.Tracks?.Next,
                Offset = spotifyAlbumDto.Tracks?.Offset ?? 0,
                Previous = spotifyAlbumDto.Tracks?.Previous,
                Total = spotifyAlbumDto.Tracks?.Total ?? 0
            },
